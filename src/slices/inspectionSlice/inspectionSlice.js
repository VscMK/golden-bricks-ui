...
export const getInspections = createAsyncThunk(
  ...
  export const updateInspection = createAsyncThunk(
    ...
    async ({id, number_of_boxes,number_occupied_combs,number_brood_combs,queen_status,queen_loss_signs,
      eggs,
      larvae,
      bee_pupae,
      adult_queen,
      ...
      try {
        const response = await InspectionService.updateInspection(id,number_of_boxes,number_occupied_combs,number_brood_combs,queen_status,queen_loss_signs,
          eggs,
          larvae,
          bee_pupae,
          adult_queen,
